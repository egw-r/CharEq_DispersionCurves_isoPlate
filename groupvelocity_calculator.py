...
def antisymmetric_disp_multiple(omega, k, thickness, rho, lamb, mu):
    """
    Parameters
    ----------
    omega: Type, float or complex array
...
def symmetric_disp_single(omega, k, thickness, rho, lamb, mu):
    """
    Parameters
    ----------
    omega: Type, float or complex array
...
def antisymmetric_disp_single(omega, k, thickness, rho, lamb, mu):
    """
    Parameters
    ----------
    omega: Type, float or complex array
...
def isotropic_single(omega, k, thickness, rho, lamb, mu, solution_type):
    ...
    if solution_type == 'symmetric':
        thick_vect, UX, UY = symmetric_disp_single(omega=omega, k=k, thickness=thickness, rho=rho, lamb=lamb, mu=mu)
    else:
        thick_vect, UX, UY = antisymmetric_disp_single(omega=omega, k=k, thickness=thickness, rho=rho, lamb=lamb, mu=mu)
